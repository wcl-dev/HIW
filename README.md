...
- **Transit vs Peering** — 你家 ISP 跟 Google 之間，是付費關係還是對等關係
- **IXP** — 為什麼全世界主要的網路交換中心都擠在少數幾棟機房裡
- **Tier 結構** — 為什麼有些網路彼此免費互連，而你家網路要付錢上去
- **Peering 戰爭** — Netflix 卡卡的時候，問題不一定在 Netflix
- **海底電纜** — 網路降速 50 天，這在技術上是怎麼回事
- **扁平化** — 為什麼 Cloudflare 故障，半個網路就一起癱瘓
